...
const MeeshoProducts = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Meesho Header */}
      <section className="bg-gradient-to-r from-[#9F2089] to-[#C94BB8] text-white py-12">
        <div className="container mx-auto px-4">
          ...
          <div className="flex items-center gap-4 mb-4">
            <div className="w-16 h-16 bg-white rounded-lg flex items-center justify-center">
              <span className="text-2xl font-bold text-[#9F2089]">m</span>
            </div>
            <div>
              <h1 className="text-4xl md:text-5xl font-bold">Meesho Products</h1>
              <p className="text-lg opacity-95">Discover quality products at unbeatable prices</p>
            </div>
          </div>
        </div>
      </section>
